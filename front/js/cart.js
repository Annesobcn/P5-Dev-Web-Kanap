...
function insertionPanier() {
  ...
  if (panierLocalStorage === null || panierLocalStorage == 0) {
    ...
    for (let items in panierLocalStorage) {
      ...
      divProduitDescription.setAttribute(
        "class",
        "car__item__content_description "
      );
      ...
      divProduitSettingsQute.setAttribute(
        "class",
      ...
      function modifierQute() {
        let parentQuantite = document.querySelector(
          "[data-id=" +
            CSS.escape(produitRef) +
            "][data-color=" +
            CSS.escape(produitCouleur) +
            "]"
        );
      ...
      function supprimerArticle() {
        let articleASupprimer = document.querySelector(
          "[data-id=" +
            CSS.escape(produitRef) +
            "][data-color=" +
            CSS.escape(produitCouleur) +
